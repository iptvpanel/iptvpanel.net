...
function addServer {
	...
	if [ -f /opt/iptvpanel2/bin/ffprobe ]; then
		...
		wget -O /opt/iptvpanel2/bin/ffprobe http://cd.iptvpanel.net/ffprobe  >> /dev/null 2>&1
		wget -O /opt/iptvpanel2/bin/ffmpeg http://cd.iptvpanel.net/ffmpeg  >> /dev/null 2>&1
